...
public class YepAuthenticationProcessingFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public YepAuthenticationProcessingFilter() {
        super(new AntPathRequestMatcher("/users/Ylogin", "POST"));
    }
    ...
    public Authentication attemptAuthentication(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws AuthenticationException, IOException, ServletException {
        ...
        YepAuthenticationToken authRequest = new YepAuthenticationToken(phone, password);
